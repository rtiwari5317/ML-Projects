# -*- coding: utf-8 -*-
"""Predicting Customer Churn Project.ipynb
...
#io.StringIO(dataset["churn.csv"].decode("utf-8"))
...
df_churned = df[df['Churn'] == 'Yes'].shape[0]
df_retained = df[df['Churn'] == 'No'].shape[0]
df_churned_prcnt = (df_churned*100)/(df_churned+df_retained)
print(df_churned_prcnt ,'% opted out of total customers from Bank')

df_retained_prcnt = (df_retained*100)/(df_churned+df_retained)
...
"""And this Completes our project on Predicting Customer Churn for our dataset where we achieved 79% Accuracy to predict whether the Customer is opting out or will continue with Bank Services..."""